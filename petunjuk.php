...
<h3 class="page-header"><i class="glyphicon glyphicon-exclamation-sign"></i> Petunjuk Mengerjakan SMAWON CBT</h3>
<div class="alert alert-info">
<p>Sebelum mengerjakan ulangan/ujian online, baca dengan cermat petunjuk berikut:</p>
...
<li>Klik tombol Selesai pada nomor terakhir untuk mengakhiri ujian. Pastikan telah mengklik tombol ini sebelum logout. Jika meninggalkan komputer sebelum klik tombol ini, maka nilai tidak akan diproses.</li>
